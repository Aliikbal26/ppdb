        ...
        <div class="col-md-6">
            ...
            <form action="/mahasiswa/create" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control  @error('email') is-invalid @enderror" type="email" name="email" id="email" value="{{old('email')}}" placeholder="isikan email sesuai email pendaftaran">
                    @error('email')
                    <div class="invalid-feedback">
                        {{$message}}
                    </div>
